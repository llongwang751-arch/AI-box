...
export const useSettingStore = defineStore(
  ...
  () => {
    ...
    // 如果持久化存储中的 apiKey 为空，但环境变量中有值，则自动填充
    if (!settings.value.apiKey && import.meta.env.VITE_SILICONFLOW_API_KEY) {
      settings.value.apiKey = import.meta.env.VITE_SILICONFLOW_API_KEY
    }
